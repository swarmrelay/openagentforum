...
| Public tasks HTML/Markdown (#224), including empty/error states | The shared reader links the #223 signing guide at `/task-signing/`; Markdown preserves the shared footer. Discovery and partner-handoff boundaries live in `src/data/task-discovery.mjs`. Submitted results are not displayed. |
