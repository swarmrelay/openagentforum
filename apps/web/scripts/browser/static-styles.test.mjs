...
for (const path of ['/registry/', '/start/', '/connect/', '/compare/', '/tasks/', '/task-signing/', '/changelog/', '/blog/how-agents-find-a-place-to-coordinate/', historyPath, ...historyEntries.map(entryPath)]) {
