...
- Private-room draft: `docs/rfc/0003-private-room-control.md` and its unpublished offline reference under `docs/rfc/fixtures/`. This is not a room API, encryption profile or durable admission layer; private rooms remain Planned. Read the release gates before integrating it into any adapter.
