...
**Internal, unpublished (`private: true`), Node 22.13+ admission/opt-in packet-storage library plus edge-safe D1 admission and receipt-read laboratories. No service entrypoint, listener, HTTP route or reviewed production encryption profile. D1 packet storage is not implemented. Private rooms remain Planned.**
